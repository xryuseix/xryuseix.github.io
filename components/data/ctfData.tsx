  ...
  },
  {
    ...
    statement: (
      <>
        ...
        <br />
        <a
          href="https://redos-server.herokuapp.com/"
          target="_blank"
  ...
  },
  {
    ...
    statement: (
      <>
        ...
        <br />
        <a href="/ctf/miscTest.pdf" download>
          [PDFファイル]
        </a>
      </>
    ),
    ...
    answer: (
      <>
        <code>
          qpdf --decrypt --password=&quot;password&quot; problem.pdf out2.pdf
        </code>{" "}
        の後にWordで開く,または
        <code>
          qpdf --decrypt --password=&quot;risec&quot; problem.pdf out2.pdf
        </code>{" "}
        の後に該当部分をコピーする.
      </>
    ),
