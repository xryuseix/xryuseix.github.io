    ...
    <Layout location={location} title={siteTitle}>
      ...
      <div class="logos">
        <div class="logo">
          ...
          <a
            href="https://twitter.com/ryusei_ishika"
            target="_blank"
        ...
        <div class="logo">
          ...
          <a
            href="https://github.com/xryuseix"
            target="_blank"
            rel="noopener noreferrer"
          >
            <div class="service_logo">
        ...
        <div class="logo">
          ...
          <a
            href="https://www.facebook.com/profile.php?id=100010586593125"
            target="_blank"
            rel="noopener noreferrer"
          >
            <div class="service_logo">
        ...
        <div class="logo">
          ...
          <a
            href="https://qiita.com/xryuseix"
            target="_blank"
            rel="noopener noreferrer"
          >
            <div class="service_logo">
              <StaticImage
                src="../../static/icons/qiita.png"
                alt="logo"
                style={imageStyle}
              />
            </div>
        ...
        <div class="logo">
          ...
          <a
            href="https://xryuseix.hatenablog.com/"
            target="_blank"
            rel="noopener noreferrer"
          >
            <div class="service_logo">
              <StaticImage
                src="../../static/icons/hatena.png"
                alt="logo"
                style={imageStyle}
              />
            </div>
        ...
        <div class="logo">
          ...
          <a
            href="https://atcoder.jp/users/xryuseix"
            target="_blank"
            rel="noopener noreferrer"
          >
            <div class="service_logo">
              <StaticImage
                src="../../static/icons/atcoder.svg"
                alt="logo"
                style={imageStyle}
              />
            </div>
        ...
        <div class="logo">
          ...
          <a
            href="https://codeforces.com/profile/xryuseix"
            target="_blank"
            rel="noopener noreferrer"
          >
            <div class="service_logo">
              <StaticImage
                src="../../static/icons/noimage.png"
                alt="logo"
                style={imageStyle}
              />
            </div>
        ...
        <div class="logo">
          ...
          <a
            href="https://leetcode.com/xryuseix/"
            target="_blank"
            rel="noopener noreferrer"
          >
            <div class="service_logo">
        ...
        <div class="logo">
          ...
          <a
            href="https://www.slideshare.net/IshikawaRyusei"
            target="_blank"
            rel="noopener noreferrer"
          >
            <div class="service_logo">
              <StaticImage
                src="../../static/icons/slideshare.png"
                alt="logo"
                style={imageStyle}
              />
            </div>
        ...
        <div class="logo">
          ...
          <a
            href="https://connpass.com/user/xryuseix/"
            target="_blank"
            rel="noopener noreferrer"
          >
            <div class="service_logo">
              <StaticImage
                src="../../static/icons/connpass.png"
                alt="logo"
                style={imageStyle}
              />
            </div>
        ...
        <div class="logo">
          ...
          <a
            href="https://www.instagram.com/ryusei_ishika/"
            target="_blank"
            rel="noopener noreferrer"
          >
            <div class="service_logo">
